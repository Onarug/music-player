...
export const Playlists = () => {
   ...
   return <div className="playlists">
        ...
        <div className="create-playlist">
            ...
            <button className="create-btn" onClick={handleCreatePlaylist}>Create Button</button>
        </div>

        <div className="playlists-list">
            {playlists.length === 0 ? (<p className="empty-message"> No playlists yet</p>) : (
                playlists.map(((playlist,key) => <div className="playlist-item" key={key}> 
                  <div className="playlist-header">
                    ...
                    <div className="playlist-songs">
                                {playlist.songs.length === 0 ? (<p className="empty-playlist"></p>) : playlist.songs.map((song,key) => 
